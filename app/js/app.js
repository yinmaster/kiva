...
function PartnersCtrl(GET_partners, $scope) {
    ...
    GET_partners.getPartnersP.promise.then(function(data) {
        ...
        function getCountries() {
            ...
            //LODASH LOOP THROUGH DATA TO FIND COUNTRIES 
            _.each(self.data, function(item, i){
                _.each(self.data[i].countries, function(country, c){
                    //PUSH COUNTRIES TO ARRAY
